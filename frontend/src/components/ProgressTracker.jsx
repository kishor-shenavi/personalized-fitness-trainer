...
const ProgressTracker = () => {
  ...
  if (error) {
    return <div className="text-center py-8 text-red-500">
      {error}
      <button onClick={fetchSessions} className="ml-4 bg-gradient-to-r from-[#00A8E8] via-[#007EA7] to-[#003459] text-white px-4 py-2 rounded">
        Retry
      </button>
    </div>;
  }
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
      <h2 className="text-2xl font-bold text-[#003459] mb-6">Workout Progress</h2>
